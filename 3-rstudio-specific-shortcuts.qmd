...
<div class = body-text>`r fontawesome::fa("angle-right", fill = "#05859B", a11y = "sem")` assignment arrow (`<-`): `option` + `-`</div>
...
<div class = body-text>`r fontawesome::fa("angle-right", fill = "#05859B", a11y = "sem")` assignment arrow (`<-`): `Alt` + `-`</div>
