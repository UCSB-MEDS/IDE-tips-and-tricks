...
.center[
<span style = 'font-size: 80%;'>`r fontawesome::fa("angle-right", fill = "#05859B", a11y = "sem")` Properly align oddly indented code: (`r fontawesome::fa("apple", fill = "#05859B", a11y = "sem")`)`command`/(`r fontawesome::fa("windows", fill = "#05859B", a11y = "sem")`)`control` + `shift` + `A`</span>
]
...
<span style = 'font-size: 80%;'>`r fontawesome::fa("apple", fill = "#05859B", a11y = "sem")` Mac keyboard shortcuts:  https://support.apple.com/en-us/HT201236</span>

<span style = 'font-size: 80%;'>`r fontawesome::fa("windows", fill = "#05859B", a11y = "sem")` Windows keyboard shortcuts: https://support.microsoft.com/en-us/windows/keyboard-shortcuts-in-windows-dcc61a57-8ff0-cffe-9796-cb9706c75eec</span>
