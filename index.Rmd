...
```
.center[
<span style = 'font-size: 75%;'>`r fontawesome::fa("windows", fill = "#05859B", a11y = "sem")` PCs use the **ctrl** (Control) and **alt** keys</span>
]
]
...
```{r, echo = FALSE, eval = TRUE, out.height='50%'}
# #............................load data...........................
# copy_cut <- googlesheets4::read_sheet("https://docs.google.com/spreadsheets/d/117mebnVTR43g8cabp8VM6zmslcRANFtKu7uQg8-r-BE/edit?usp=sharing")
# 
# #...........................edit cells...........................
# # copy_cut[1,2] <- 
# #cell_spec(copy_cut[1,2], monospace = TRUE)
# 
# #..........................build table...........................
# copy_cut_tbl <- copy_cut %>% 
#   kable(col.names = c("Action", "Mac", "PC"), format = "html", escape = FALSE, table.attr = "style='height:60%;'") %>% 
#   kable_styling(full_width = TRUE) #%>% 
#   #kableExtra::row_spec(1, extra_css = "border-bottom: 1px solid gainsboro")
# 
# kable_classic(copy_cut_tbl)
```
...
<span style = 'font-size: 80%;'>`r fontawesome::fa("angle-right", fill = "#05859B", a11y = "sem")` {magrittr} pipe operator (`%>%`): (`r fontawesome::fa("apple", fill = "#05859B", a11y = "sem")` & `r fontawesome::fa("apple", fill = "#05859B", a11y = "sem")`) `control` + `shift` + `M`</span>  
...
.footnote[This is particularly helpful when you are troubleshooting code -- quickly comment/uncomment sections of code to help isolate the error!]
...
---
## Soft wrap long lines & rainbow parenthases

---
## code snippets

Tools -> Global Options -> Code -> Enable Code Snippets

---
## Console

Tools -> Global Options -> Console -> Limit Visible Console Output (default = 1000 lines)

---
## RStudio Appearance 

Tools -> Global Options -> Appearance -> RStudio Theme/Font Size/Font Style/Zoom 

---
## `r fontawesome::fa("info-circle", fill = "#05859B", a11y = "sem")` More keyboard shortcuts
